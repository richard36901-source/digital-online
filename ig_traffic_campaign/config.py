...
# לסרטונים הממוספרים (1.mov..8.mov) השם עצמו כבר מדויק.
# אם "match" לא ימצא קובץ יחיד וברור - הסקריפט יעצור בשגיאה במקום לנחש.
VIDEOS = [
    {"match": "בסוף אנשים קונים מחקרים", "ad_set_name": "בסוף אנשים קונים מחקרים",
     "message": "בסוף אנשים קונים מחקרים, לא דעות. עוד תוכן כזה - עקבו באינסטגרם"},
    {"match": "שוק ההון או נדל", "ad_set_name": "שוק ההון או נדל\"ן",
    ...
    {"match": "למה קהילה זה כזה חשוב", "ad_set_name": "למה קהילה זה כזה חשוב",
    ...
    {"match": f"{i}.mov", "ad_set_name": f"סרטון {i}",
